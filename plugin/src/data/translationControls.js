export default [
  {
    ...
    descriptionEn: "When there is no sign for the word, translate the letters of the word into sign language",
    active: false
  },
  {
    id: 2,
    ...
    descriptionEn: "Adding signs of verb tense, flexural, masculine, feminine, and other language rules",
    active: false
  },
  {
    id: 3,
    ...
    descriptionEn:
      "When activated, a sign language translation icon will be added to the end of each text on the site. When you click on it, the text will be translated into sign language.",
    active: false
  },
  {
    id: 4,
    ...
    descriptionEn:
      "Upon activation, the chosen Arabic text is analyzed and the diacritics options for the words are shown until the user chooses the correct diacritics and then begins translation in sign language.",
    active: false
  },
  {
    id: 5,
    ...
    descriptionEn: "When activated and while translating text words, it colors the status word whose reference appears in the video while displaying the translation",
    active: false
  },
  {
    id: 6,
    ...
    descriptionEn: "Upon activation, it identifies the type of number, whether it is a date, mobile number, or something else, and reads it correctly by simulating reality.",
    active: false
  },
  {
    id: 7,
    ...
    descriptionEn: "Upon activation and after selecting the colloquial dialect, colloquial words can be translated according to the selected country and dialect",
    active: false
  }
];
